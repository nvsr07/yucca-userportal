...
public abstract class I18nServlet extends HttpServlet {
	...
	protected abstract JSONObject loadMessages(Locale currentLocale) throws MalformedURLException;
	protected abstract String formatMessages(JSONObject messages, Locale locale);
